...
rib1 = Electrode('ribbon', ribbon_angle=8.4)
rib2 = Electrode('ribbon', ribbon_angle=11.4)
rib3 = Electrode('ribbon', ribbon_angle=27.1)
...
potentials= np.array([  0,     0, -10, 150,  300,  450,  600])*1000 # Volts
...
W0 = .320e6*1.5 * e # Twice the max grid voltage bc Z=2 for alphas
